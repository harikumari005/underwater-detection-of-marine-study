...
Original file is located at
    https://colab.research.google.com/drive/1yOwFcebTDVd47kjl9AVN6humjdaCOWxJ
"""
...
for fname in uploaded.keys():
    ...
    # Make green object highlight
    green = np.zeros_like(image)
    green[:] = (0, 255, 0)  # BGR for green
    highlighted = cv2.bitwise_and(green, green, mask=object_mask)
    ...
    plt.title("Objects in Green, Water is Black")
    plt.axis("off")
